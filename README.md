...
It allows users to create meeting rooms, share invite links, join video calls from different networks, chat in real time, and save meeting history securely.
...
**Sample Meeting Link:**
https://frontend-one-snowy-92.vercel.app/meet-khushi
...
4. Copy the generated meeting link.
5. Share the link with another user.
6. Both users open the same link.
